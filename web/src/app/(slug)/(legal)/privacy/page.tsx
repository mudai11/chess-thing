...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Privacy | Chess Thing",
    description: "Read the chess thing Privacy Policy.",
  };
}
  ...
  return (
    <div className="prose dark:prose-invert container justify-center py-10">
      ...
      <p>
        ...
        shared and/or collect in Chess Thing. This policy is not applicable to
      ...
      <p>
        ...
        advertising partners of Chess Thing.
      </p>
      ...
      <p>
        Note that Chess Thing has no access to or control over these cookies
      ...
      <p>
        Chess Thing does not knowingly collect any Personal Identifiable
