...
const StartGameButton = () => {
  return (
    <>
      <Button
        asChild
        className="hero-play-button group relative w-fit overflow-hidden rounded-xl p-[2px] font-bold transition-all duration-300 hover:bg-transparent hover:shadow-[0_0_2rem_-0.5rem_#4b7399] dark:hidden md:mr-0 lg:mr-auto"
      >
        <div className="cursor-pointer">
          <span className="lg:inline-flex h-full flex items-center justify-center w-[250px] lg:w-fit gap-1 rounded-[10px] bg-white px-4 py-2 text-md text-[#4b7399] transition-all duration-300">
