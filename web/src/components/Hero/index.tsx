  ...
  return (
    <section className="flex flex-row items-center">
      <div className="max-w-[500px] pt-20 lg:pt-0 flex flex-col justify-center items-center lg:items-start gap-3">
        <h1 className="text-[50px] md:text-[60px] lg:text-[80px] font-bold bg-gradient-to-r from-black to-amber-500 dark:from-white dark:to-amber-500 text-transparent bg-clip-text">
          Chess Thing
        </h1>
